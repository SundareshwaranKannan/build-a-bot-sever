...
// to solve routing prblm bcoz of html 5 history mode
...
// Note(Sundar) : after running npm run build in my build-a-bot vue project, copy the dist folder to this project
// run -> npm install --save connect-history-api-fallback
// this is to avoid routing problems such as localhost:8082/build will fail becoz we enable html 5 history mode to remove the # symbol from url
